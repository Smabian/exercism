...
export function canFreePrisoner(
  ...
  if (petDogIsPresent == false && knightIsAwake == false && archerIsAwake == false && prisonerIsAwake == false) {
    return false;
  } else if(knightIsAwake == false && archerIsAwake == false) {
    return true;
  } else if (petDogIsPresent == true && knightIsAwake == true && archerIsAwake == false) {
    return true;
  }  else {
    return false;
  }
